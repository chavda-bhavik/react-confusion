...
class Contact extends Component {
    constructor(props) {
        super(props)
        this.handleInputChange = this.handelInputChange.bind(this)
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={(event) => this.handleSubmit(event)}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="textarea" id="message" name="message" placeholder="Your Message" rows="12" value={this.state.message} onChange={this.handleInputChange} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
